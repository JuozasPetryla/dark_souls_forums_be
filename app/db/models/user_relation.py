...
class UserRelation(Base):
    ...
    status = Column(Enum(UserRelationStatuses), nullable=False, server_default=UserRelationStatuses.PENDING.value)
    type = Column(Enum(UserRelationTypes), nullable=False)
